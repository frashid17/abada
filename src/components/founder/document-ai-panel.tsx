        ...
        <aside>
          ...
          >
            <div className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary/15 to-cta/10 text-primary">
              {locked ? <Lock className="h-5 w-5" aria-hidden /> : <Sparkles className="h-5 w-5" aria-hidden />}
              {messages.length > 0 ? (
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-sm text-muted-foreground">
                {locked ? tPay("lockedHint") : (lastAssistantMessage?.content ?? t("welcomeShort"))}
              </p>
            </div>
          ...
          {locked ? (
            <div className="flex h-full flex-col items-center justify-center gap-5 py-6 text-center">
              ...
              <div className="space-y-2">
                <p className="font-serif text-lg font-semibold text-foreground">{tPay("lockedTitle")}</p>
              ...
              <p className="text-[11px] text-muted-foreground">{tPay("mockNote")}</p>
            </div>
          ) : messages.length === 0 ? (
